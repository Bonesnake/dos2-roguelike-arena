...
vertex VertexOutput Materials_RoguelikeArena_SourceBeacon_Core_On_SK_FOR_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
fragment PixelOutput Materials_RoguelikeArena_SourceBeacon_Core_On_SK_FOR_Metal_fragmentMain(constant LocalUniformsPS& uniforms,
