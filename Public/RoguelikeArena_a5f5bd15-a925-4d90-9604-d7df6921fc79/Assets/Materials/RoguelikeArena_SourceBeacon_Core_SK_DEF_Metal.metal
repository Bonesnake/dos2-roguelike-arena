...
vertex VertexOutput Materials_RoguelikeArena_SourceBeacon_Core_SK_DEF_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
fragment PixelOutput Materials_RoguelikeArena_SourceBeacon_Core_SK_DEF_Metal_fragmentMain(constant LocalUniformsPS& uniforms,
