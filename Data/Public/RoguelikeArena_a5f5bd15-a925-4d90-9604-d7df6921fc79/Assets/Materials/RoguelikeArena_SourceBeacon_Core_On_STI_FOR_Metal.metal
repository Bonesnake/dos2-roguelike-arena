...
vertex VertexOutput Materials_RoguelikeArena_SourceBeacon_Core_On_STI_FOR_Metal_vertexMain(constant PerView& perView [[buffer(5)]],
...
fragment PixelOutput Materials_RoguelikeArena_SourceBeacon_Core_On_STI_FOR_Metal_fragmentMain(constant LocalUniformsPS& uniforms,
