...
vertex VertexOutput Materials_RoguelikeArena_Gizmo_Trigger_Spawner_SK_SHA_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
fragment PixelOutput Materials_RoguelikeArena_Gizmo_Trigger_Spawner_SK_SHA_Metal_fragmentMain(constant LocalUniformsPS& uniforms,
